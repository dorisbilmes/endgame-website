...
export function TeamSection() {
  return (
    <section className="py-24 bg-[var(--color-canvas)] w-full">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 pb-16 mb-16 border-b border-[var(--color-border-light)]">
        <h2 className="text-[32px] font-medium text-[var(--color-text)] max-w-2xl">
