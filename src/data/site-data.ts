...
export const featuredBlogPosts: FeaturedBlogPost[] = [
  {
    ...
    description: "Most Endgame demos end with the same question:",
  ...
  },
  {
    ...
    description: "CROs have spent the last two years trying to make their teams AI-native.",
  ...
  },
  {
    ...
    description: "We recently wrote about how Templates help reps execute your sales methodology consistently.",
