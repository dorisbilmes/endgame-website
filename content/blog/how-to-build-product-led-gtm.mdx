...
![how to build product led gtm](/images/blog/content/how-to-build-product-led-gtm-01.jpeg)
...
Whether it be homegrown, in a data warehouse, or using a CDP like Segment, properly tracked data is the must have before embarking on this journey. Follow [best practices](https://segment.com/academy/collecting-data/how-to-create-a-tracking-plan/) to build a data tracking plan to help connect the goals across the GTM and engineering teams who will be implementing the tracks.
