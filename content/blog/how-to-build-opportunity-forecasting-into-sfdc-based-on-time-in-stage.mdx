...
If you read the [first part of our [Rescale](https://rescale.com/) interview](/blog/how-rescale-builds-compensation-plans-for-new-expansion-and-renewal-revenue), you learned all about how Rescale's VP of Operations, [Gabe Rothman](https://www.linkedin.com/in/gprothman/), thinks about compensation planning. In part two, we'll dive into exactly how Rescale built their opportunity forecasting engine to balance renewals and expansion.

What tools does Rescale use to manage all their growth, anyway? Salesforce – with a nightly data transfer into their data warehouse – paired with Varicent's [Incentives for Growth](https://www.varicent.com/sales-compensation-software) commission tool.
...
![how-to-build-opportunity-forecasting-into-sfdc-based-on-time-in-stage](/images/blog/content/how-to-build-opportunity-forecasting-into-sfdc-based-on-time-in-stage-01.jpeg)
...
![how-to-build-opportunity-forecasting-into-sfdc-based-on-time-in-stage](/images/blog/content/how-to-build-opportunity-forecasting-into-sfdc-based-on-time-in-stage-02.png)


![How to build opportunity forecasting into SFDC](/images/blog/content/how-to-build-opportunity-forecasting-into-sfdc-based-on-time-in-stage-01.jpeg)

![How to build opportunity forecasting into SFDC](/images/blog/content/how-to-build-opportunity-forecasting-into-sfdc-based-on-time-in-stage-02.png)
...
![how to build opportunity forecasting into sfdc based on time in stage](/images/blog/content/how-to-build-opportunity-forecasting-into-sfdc-based-on-time-in-stage-03.png)

![how to build opportunity forecasting into sfdc based on time in stage](/images/blog/content/how-to-build-opportunity-forecasting-into-sfdc-based-on-time-in-stage-04.png)
...
*Want to hear more from Gabe? Check out the full interview [here](https://youtu.be/BLOF14Zmh3E).*
