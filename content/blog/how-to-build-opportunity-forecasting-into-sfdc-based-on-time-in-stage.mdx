...
description: >-
  If you read the first part of our [Rescale
  interview](/blog/how-rescale-builds-compensation-plans-for-new-expansion-and-renewal-revenue),
  you learned all about how Rescale's VP of Operations, Gabe Rothman, thinks
  about compensation planning.
...
If you read the [first part of our Rescale interview](/blog/how-rescale-builds-compensation-plans-for-new-expansion-and-renewal-revenue), you learned all about how [Rescale's](https://rescale.com/) VP of Operations, [Gabe Rothman](https://www.linkedin.com/in/gprothman/), thinks about compensation planning. In part two, we'll dive into exactly how Rescale built their opportunity forecasting engine to balance renewals and expansion.
...
<Quote>
"We can answer questions like, 'Where did they end up? How accurate were they? What did the model say about their cohort?' From there, we can help them to adjust based on the coaching mechanism." - Gabe Rothman
</Quote>
