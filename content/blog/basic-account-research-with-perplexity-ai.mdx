...
description: >-
  This post is first in a series on how AI can help with various aspects of
...
Here, we're using [Perplexity](https://www.perplexity.ai/) because it is very good at quickly aggregating and summarizing public web results, whereas a tool like ChatGPT is better suited to work on a well-defined data set. We'll use ChatGPT in a future post about researching earnings call transcripts and 10-Ks.
...
![basic account research with perplexity ai](/images/blog/content/basic-account-research-with-perplexity-ai-01.png)
...
![basic account research with perplexity ai](/images/blog/content/basic-account-research-with-perplexity-ai-02.png)
...
![basic account research with perplexity ai](/images/blog/content/basic-account-research-with-perplexity-ai-03.png)
...
![basic account research with perplexity ai](/images/blog/content/basic-account-research-with-perplexity-ai-07.png)
