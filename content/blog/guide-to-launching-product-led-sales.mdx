...
description: Product-led sales = product data + sales.
...
Below is an example of how Figma uses a combination of ICP Fit and Product signals to prioritize accounts for sales. You can read more in [Kyle Poyar's Guide to Product-led Sales with Jesus Requena](https://kylepoyar.substack.com/p/your-guide-to-product-led-sales).

![FIT level vs Readiness Level](/images/blog/content/guide-to-launching-product-led-sales-04.png)
...
![Product signals one-pager example](/images/blog/content/key-image-upsell.png)
