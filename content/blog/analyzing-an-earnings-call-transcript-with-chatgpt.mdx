...
description: >-
  This post is the third in a series on how AI can help with various aspects of
...
Here, we again use [ChatGPT](https://chatgpt.com/?oai-dm=1) because it is excellent at taking and analyzing a specific file or dataset. In this case, we want to give ChatGPT the transcript of the earnings call and ask it to go to town.
...
![analyzing an earnings call transcript with chatgpt](/images/blog/content/analyzing-an-earnings-call-transcript-with-chatgpt-01.png)

Then, open up a fresh ChatGPT window, and use the "attach" button to upload the PDF, send it, and you're ready to go!

![analyzing-an-earnings-call-transcript-with-chatgpt](/images/blog/content/analyzing-an-earnings-call-transcript-with-chatgpt-02.png)
...
![analyzing an earnings call transcript with chatgpt](/images/blog/content/analyzing-an-earnings-call-transcript-with-chatgpt-03.png)
...
![analyzing an earnings call transcript with chatgpt](/images/blog/content/analyzing-an-earnings-call-transcript-with-chatgpt-07.png)
...
![analyzing an earnings call transcript with chatgpt](/images/blog/content/analyzing-an-earnings-call-transcript-with-chatgpt-08.png)
...
![analyzing an earnings call transcript with chatgpt](/images/blog/content/analyzing-an-earnings-call-transcript-with-chatgpt-09.png)
...
![analyzing an earnings call transcript with chatgpt](/images/blog/content/analyzing-an-earnings-call-transcript-with-chatgpt-10.png)
