...
![series-b-announcement](/images/blog/content/series-b-announcement-01.jpeg)
...
- We have added [a number of customers to our list](/customers), including Retool, LaunchDarkly, Airbyte, Algolia, Shortcut, ContentFly, and Grain
...
![series b announcement](/images/blog/content/series-b-announcement-02.jpeg)
...
Our Series B raise gives us an additional $30M, and a total funding amount of $47.5M, to deliver on our promise. The round was [led by Laura Yao](https://twitter.com/laura_yao/status/1491078750775443458) of EQT Ventures and we're very excited to have her join our board as an observer. Laura sits on multiple boards—including Netlify and Airkit—and brings invaluable insight to business building in a product-led world. You can read more from Laura in [her blog post](https://medium.com/eqtventures/on-eqt-ventures-investment-in-endgame-the-operating-system-for-product-led-sales-be6d873f0673).
...
If you're interested in working with us, we're hiring across all functions, including but not limited to data science, engineering, product, marketing, and customer success. You can [see currently open jobs](/https://jobs.lever.co/endgame.io) or you can reach out to talk to us for any role.
