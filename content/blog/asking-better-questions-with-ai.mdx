...
description: >-
  When we launched Endgame with the promise that you could Ask Anything, we
  meant it.
...
Ready to start asking better questions? Check out our complete [Prompting Guide](https://docs.endgame.io/endgame-chat-201) for more examples and best practices.
